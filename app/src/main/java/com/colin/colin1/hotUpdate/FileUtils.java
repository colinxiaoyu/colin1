...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        Utils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        Utils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new UnknownException("Error closing IO resources.", e);
                    }
                }
            }
        }
    ...
    public static void deleteDirectoryAtPath(String directoryPath) {
        if (directoryPath == null) {
            Utils.log("deleteDirectoryAtPath attempted with null directoryPath");
            return;
        }
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            Utils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new UnknownException("Unable to move file from " +
